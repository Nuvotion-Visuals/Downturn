...
*                                                                                                     Entity status                                                                                            :                                                                                                     new                                                                                            
  *                                                                                                     Assoc status                                                                                            :                                                                                                     new                                                                                            
  *                                                                                                     next trigger timestamp in Assoc                                                                                            :                                                                                                     scheduled_timestamp of the task                                                                                            
  *                                                                                                     Comment                                                                                            :                                                                                                     Pick up new tasks that are ready.                                                                                             
*                                                                                                     Entity status                                                                                            :                                                                                                     enqueued                                                                                            
  *                                                                                                     Assoc status                                                                                            :                                                                                                     started                                                                                            
  *                                                                                                     next trigger timestamp in Assoc                                                                                            :                                                                                                     enqueued_timestamp + enqueue_timeout                                                                                            
  *                                                                                                     Comment                                                                                            :                                                                                                     Re-enqueue task if it has been in enqueued state for too long. This can happen if the queue loses data or the controller goes down after polling the queue and before the task is claimed.                                                                                            
*                                                                                                     Entity status                                                                                            :                                                                                                     claimed                                                                                            
  *                                                                                                     Assoc status                                                                                            :                                                                                                     started                                                                                            
  *                                                                                                     next trigger timestamp in Assoc                                                                                            :                                                                                                     claimed_timestamp + claim_timeout                                                                                            
  *                                                                                                     Comment                                                                                            :                                                                                                     Re-enqueue if task is claimed but never transfered to processing. This can happen if Controller is down after claiming a task. Task status is changed to enqueued after re-enqueue.                                                                                            
*                                                                                                     Entity status                                                                                            :                                                                                                     processing                                                                                            
  *                                                                                                     Assoc status                                                                                            :                                                                                                     started                                                                                            
  *                                                                                                     next trigger timestamp in Assoc                                                                                            :                                                                                                     heartbeat_timestamp + heartbeat_timeout`                                                                                            
  *                                                                                                     Comment                                                                                            :                                                                                                     Re-enqueue if task hasn’t sent heartbeat for too long. This can happen if Executor is down. Task status is changed to enqueued after re-enqueue.                                                                                             
*                                                                                                     Entity status                                                                                            :                                                                                                     retriable failure                                                                                            
  *                                                                                                     Assoc status                                                                                            :                                                                                                     started                                                                                            
  *                                                                                                     next trigger timestamp in Assoc                                                                                            :                                                                                                     compute next_timestamp according to backoff logic                                                                                            
  *                                                                                                     Comment                                                                                            :                                                                                                     Exponential backoff for tasks with retriable failure.                                                                                             
*                                                                                                     Entity status                                                                                            :                                                                                                     success                                                                                            
  *                                                                                                     Assoc status                                                                                            :                                                                                                     completed                                                                                            
  *                                                                                                     next trigger timestamp in Assoc                                                                                            :                                                                                                     N/A                                                                                            
  *                                                                                                     Comment                                                                                            :                                                                                             
*                                                                                                     Entity status                                                                                            :                                                                                                     fatal_failure                                                                                            
  *                                                                                                     Assoc status                                                                                            :                                                                                                     completed                                                                                            
  *                                                                                                     next trigger timestamp in Assoc                                                                                            :                                                                                                     N/A                                                                                            
  *                                                                                                     Comment                                                                                            :                                                                                             
