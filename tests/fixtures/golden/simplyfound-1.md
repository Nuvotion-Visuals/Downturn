...
Raspberry Pi 3 is now available via many online resellers.  At this time, you should use a recent **32-bit** NOOBS or Raspbian image from their [downloads](https://www.raspberrypi.org/downloads/) page with a promise of a switch to a 64-bit version only if further investigation proves that there is indeed some value in moving to 64-bit mode.