...
(for more details about V8 and its garbage collector you can read my previous article [here](http://fakehost/voodoo-engineering/nodejs-internals-v8-garbage-collector-a6eca82540ec))
...
**To sum up**: we are able to trigger a CPU profiling, on-demand, in real-time, without interruption or connection to the server. Data can be collected on the disk (and extracted later) or can be sent to S3 (or any other system, PR are welcomed on the [inspector-api project](https://github.com/wallet77/v8-inspector-api)).
...
*   [https://medium.com/netflix-techblog/node-js-in-flames-ddd073803aa4](http://fakehost/netflix-techblog/node-js-in-flames-ddd073803aa4)
