...
Web standards are important, and Daring Fireball adheres to them. Specifically, Daring Fireball’s HTML markup should validate as either [HTML 5](http://www.whatwg.org/specs/web-apps/current-work/) or XHTML 4.01 Transitional, its layout is constructed using [valid CSS](http://jigsaw.w3.org/css-validator/validator?uri=http://daringfireball.net/css/fireball_screen.css), and its syndicated feed is [valid Atom](http://feedvalidator.org/check?url=http%3A%2F%2Fdaringfireball.net%2Findex.xml).
