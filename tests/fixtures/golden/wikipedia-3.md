...
In mathematics, a **Hermitian matrix** (or **self-adjoint matrix**) is a [complex](http://fakehost/wiki/Complex_number "Complex number") [square matrix](http://fakehost/wiki/Square_matrix "Square matrix") that is equal to its own [conjugate transpose](http://fakehost/wiki/Conjugate_transpose "Conjugate transpose")—that is, the element in the i\-th row and j\-th column is equal to the [complex conjugate](http://fakehost/wiki/Complex_conjugate "Complex conjugate") of the element in the j\-th row and i\-th column, for all indices i and j:
...
Hermitian matrices can be understood as the complex extension of real [symmetric matrices](http://fakehost/wiki/Symmetric_matrix "Symmetric matrix").

If the [conjugate transpose](http://fakehost/wiki/Conjugate_transpose "Conjugate transpose") of a matrix ![A](https://wikimedia.org/api/rest_v1/media/math/render/svg/7daff47fa58cdfd29dc333def748ff5fa4c923e3) is denoted by ![{\displaystyle A^{\mathsf {H}}}](https://wikimedia.org/api/rest_v1/media/math/render/svg/d9415702ab196cc26f5df37af2d90e07318e93df), then the Hermitian property can be written concisely as
...
Hermitian matrices are named after [Charles Hermite](http://fakehost/wiki/Charles_Hermite "Charles Hermite"), who demonstrated in 1855 that matrices of this form share a property with real symmetric matrices of always having real [eigenvalues](http://fakehost/wiki/Eigenvalues_and_eigenvectors "Eigenvalues and eigenvectors"). Other, equivalent notations in common use are ![{\displaystyle A^{\mathsf {H}}=A^{\dagger }=A^{\ast }}](https://wikimedia.org/api/rest_v1/media/math/render/svg/8aa270391d183478251283d2c4b2c72ac4563352), although note that in [quantum mechanics](http://fakehost/wiki/Quantum_mechanics "Quantum mechanics"), ![A^{\ast }](https://wikimedia.org/api/rest_v1/media/math/render/svg/5541bfa07743be995242c892c344395e672d6fa2) typically means the [complex conjugate](http://fakehost/wiki/Complex_conjugate "Complex conjugate") only, and not the [conjugate transpose](http://fakehost/wiki/Conjugate_transpose "Conjugate transpose").

Alternative characterizations\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=1 "Edit section: Alternative characterizations")\]
------------------------------------------------------------------------------------------------------------------------------------------------

Hermitian matrices can be characterized in a number of equivalent ways, some of which are listed below:

### Equality with the adjoint\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=2 "Edit section: Equality with the adjoint")\]

A square matrix ![A](https://wikimedia.org/api/rest_v1/media/math/render/svg/7daff47fa58cdfd29dc333def748ff5fa4c923e3) is Hermitian if and only if it is equal to its [adjoint](http://fakehost/wiki/Hermitian_adjoint "Hermitian adjoint"), that is, it satisfies
...
for any pair of vectors ![v,w](https://wikimedia.org/api/rest_v1/media/math/render/svg/6425c6e94fa47976601cb44d7564b5d04dcfbfef), where ![{\displaystyle \langle \cdot ,\cdot \rangle }](https://wikimedia.org/api/rest_v1/media/math/render/svg/9a50080b735975d8001c9552ac2134b49ad534c0) denotes [the inner product](http://fakehost/wiki/Dot_product "Dot product") operation.

This is also the way that the more general concept of [self-adjoint operator](http://fakehost/wiki/Self-adjoint_operator "Self-adjoint operator") is defined.

### Reality of quadratic forms\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=3 "Edit section: Reality of quadratic forms")\]
...
### Spectral properties\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=4 "Edit section: Spectral properties")\]

A square matrix ![A](https://wikimedia.org/api/rest_v1/media/math/render/svg/7daff47fa58cdfd29dc333def748ff5fa4c923e3) is Hermitian if and only if it is unitarily [diagonalizable](http://fakehost/wiki/Diagonalizable_matrix "Diagonalizable matrix") with real [eigenvalues](http://fakehost/wiki/Eigenvalues_and_eigenvectors "Eigenvalues and eigenvectors").

Applications\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=5 "Edit section: Applications")\]
--------------------------------------------------------------------------------------------------------------

Hermitian matrices are fundamental to the quantum theory of [matrix mechanics](http://fakehost/wiki/Matrix_mechanics "Matrix mechanics") created by [Werner Heisenberg](http://fakehost/wiki/Werner_Heisenberg "Werner Heisenberg"), [Max Born](http://fakehost/wiki/Max_Born "Max Born"), and [Pascual Jordan](http://fakehost/wiki/Pascual_Jordan "Pascual Jordan") in 1925.

Examples\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=6 "Edit section: Examples")\]
------------------------------------------------------------------------------------------------------
...
The diagonal elements must be [real](http://fakehost/wiki/Real_number "Real number"), as they must be their own complex conjugate.

Well-known families of [Pauli matrices](http://fakehost/wiki/Pauli_matrices "Pauli matrices"), [Gell-Mann matrices](http://fakehost/wiki/Gell-Mann_matrices "Gell-Mann matrices") and their generalizations are Hermitian. In [theoretical physics](http://fakehost/wiki/Theoretical_physics "Theoretical physics") such Hermitian matrices are often multiplied by [imaginary](http://fakehost/wiki/Imaginary_number "Imaginary number") coefficients,[\[1\]](#cite_note-1)
[\[2\]](#cite_note-2) which results in _skew-Hermitian_ matrices (see [below](#facts)).

Here, we offer another useful Hermitian matrix using an abstract example. If a square matrix ![A](https://wikimedia.org/api/rest_v1/media/math/render/svg/7daff47fa58cdfd29dc333def748ff5fa4c923e3) equals the [multiplication of a matrix](http://fakehost/wiki/Matrix_multiplication "Matrix multiplication") and its conjugate transpose, that is, ![{\displaystyle A=BB^{\mathsf {H}}}](https://wikimedia.org/api/rest_v1/media/math/render/svg/3f0efab2d7c3a4b4b7caf14cc0705dadd13195a9), then ![A](https://wikimedia.org/api/rest_v1/media/math/render/svg/7daff47fa58cdfd29dc333def748ff5fa4c923e3) is a Hermitian [positive semi-definite matrix](http://fakehost/wiki/Positive_semi-definite_matrix "Positive semi-definite matrix"). Furthermore, if ![B](https://wikimedia.org/api/rest_v1/media/math/render/svg/47136aad860d145f75f3eed3022df827cee94d7a) is row full-rank, then ![A](https://wikimedia.org/api/rest_v1/media/math/render/svg/7daff47fa58cdfd29dc333def748ff5fa4c923e3) is positive definite.

Properties\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=7 "Edit section: Properties")\]
----------------------------------------------------------------------------------------------------------



*   The entries on the [main diagonal](http://fakehost/wiki/Main_diagonal "Main diagonal") (top left to bottom right) of any Hermitian matrix are [real](http://fakehost/wiki/Real_number "Real number").
...
Only the [main diagonal](http://fakehost/wiki/Main_diagonal "Main diagonal") entries are necessarily real; Hermitian matrices can have arbitrary complex-valued entries in their [off-diagonal elements](http://fakehost/wiki/Off-diagonal_element "Off-diagonal element"), as long as diagonally-opposite entries are complex conjugates.

*   A matrix that has only real entries is Hermitian [if and only if](http://fakehost/wiki/If_and_only_if "If and only if") it is [symmetric](http://fakehost/wiki/Symmetric_matrix "Symmetric matrix"). A real and symmetric matrix is simply a special case of a Hermitian matrix.
...
*   Every Hermitian matrix is a [normal matrix](http://fakehost/wiki/Normal_matrix "Normal matrix"). That is to say, AAH = AHA.

_Proof:_ A = AH, so AAH = AA = AHA.

*   The finite-dimensional [spectral theorem](http://fakehost/wiki/Spectral_theorem "Spectral theorem") says that any Hermitian matrix can be [diagonalized](http://fakehost/wiki/Diagonalizable_matrix "Diagonalizable matrix") by a [unitary matrix](http://fakehost/wiki/Unitary_matrix "Unitary matrix"), and that the resulting diagonal matrix has only real entries. This implies that all [eigenvalues](http://fakehost/wiki/Eigenvectors "Eigenvectors") of a Hermitian matrix A with dimension n are real, and that A has n linearly independent [eigenvectors](http://fakehost/wiki/Eigenvector "Eigenvector"). Moreover, a Hermitian matrix has [orthogonal](http://fakehost/wiki/Orthogonal "Orthogonal") eigenvectors for distinct eigenvalues. Even if there are degenerate eigenvalues, it is always possible to find an [orthogonal basis](http://fakehost/wiki/Orthogonal_basis "Orthogonal basis") of ℂ_n_ consisting of n eigenvectors of A.
...
*   The [inverse](http://fakehost/wiki/Inverse_matrix "Inverse matrix") of an invertible Hermitian matrix is Hermitian as well.
...
*   The [product](http://fakehost/wiki/Matrix_multiplication "Matrix multiplication") of two Hermitian matrices A and B is Hermitian if and only if _AB_ = _BA_.

_Proof:_ Note that ![{\displaystyle (AB)^{\mathsf {H}}={\overline {(AB)^{\mathsf {T}}}}={\overline {B^{\mathsf {T}}A^{\mathsf {T}}}}={\overline {B^{\mathsf {T}}}}{\overline {A^{\mathsf {T}}}}=B^{\mathsf {H}}A^{\mathsf {H}}=BA.}](https://wikimedia.org/api/rest_v1/media/math/render/svg/b6cf8185ca7a0687bf959bb65b16db6cf1714ca2) Thus ![{\displaystyle (AB)^{\mathsf {H}}=AB}](https://wikimedia.org/api/rest_v1/media/math/render/svg/d303a1ebcac8547489b170be5d0dd7d8e04e548e) [if and only if](http://fakehost/wiki/If_and_only_if "If and only if") ![AB=BA](https://wikimedia.org/api/rest_v1/media/math/render/svg/992c8ea49fdd26b491180036c5a4d879fec77442).

Thus _A__n_ is Hermitian if A is Hermitian and n is an integer.

*   The Hermitian complex n\-by-n matrices do not form a [vector space](http://fakehost/wiki/Vector_space "Vector space") over the [complex numbers](http://fakehost/wiki/Complex_number "Complex number"), ℂ, since the identity matrix _I__n_ is Hermitian, but _i_ _I__n_ is not. However the complex Hermitian matrices _do_ form a vector space over the [real numbers](http://fakehost/wiki/Real_numbers "Real numbers") ℝ. In the 2_n_2\-[dimensional](http://fakehost/wiki/Dimension_of_a_vector_space "Dimension of a vector space") vector space of complex _n_ × _n_ matrices over ℝ, the complex Hermitian matrices form a subspace of dimension _n_2. If _E__jk_ denotes the n\-by-n matrix with a 1 in the _j_,_k_ position and zeros elsewhere, a basis (orthonormal w.r.t. the Frobenius inner product) can be described as follows:
...
Decomposition into Hermitian and skew-Hermitian\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=8 "Edit section: Decomposition into Hermitian and skew-Hermitian")\]
------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
...
Rayleigh quotient\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=9 "Edit section: Rayleigh quotient")\]
------------------------------------------------------------------------------------------------------------------------
...
See also\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=10 "Edit section: See also")\]
-------------------------------------------------------------------------------------------------------

*   [Vector space](http://fakehost/wiki/Vector_space "Vector space")
*   [Skew-Hermitian matrix](http://fakehost/wiki/Skew-Hermitian_matrix "Skew-Hermitian matrix") (anti-Hermitian matrix)
*   [Haynsworth inertia additivity formula](http://fakehost/wiki/Haynsworth_inertia_additivity_formula "Haynsworth inertia additivity formula")
*   [Hermitian form](http://fakehost/wiki/Hermitian_form "Hermitian form")
*   [Self-adjoint operator](http://fakehost/wiki/Self-adjoint_operator "Self-adjoint operator")
*   [Unitary matrix](http://fakehost/wiki/Unitary_matrix "Unitary matrix")

References\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=11 "Edit section: References")\]
-----------------------------------------------------------------------------------------------------------

1.  **[^](#cite_ref-1)** [Frankel, Theodore](http://fakehost/wiki/Theodore_Frankel "Theodore Frankel") (2004). [_The Geometry of Physics: an introduction_](https://books.google.com/books?id=DUnjs6nEn8wC&lpg=PA652&dq=%22Lie%20algebra%22%20physics%20%22skew-Hermitian%22&pg=PA652#v=onepage&q&f=false). [Cambridge University Press](http://fakehost/wiki/Cambridge_University_Press "Cambridge University Press"). p. 652. [ISBN](http://fakehost/wiki/International_Standard_Book_Number "International Standard Book Number") [0-521-53927-7](http://fakehost/wiki/Special:BookSources/0-521-53927-7 "Special:BookSources/0-521-53927-7").
2.  **[^](#cite_ref-2)** [Physics 125 Course Notes](http://www.hep.caltech.edu/~fcp/physics/quantumMechanics/angularMomentum/angularMomentum.pdf) at [California Institute of Technology](http://fakehost/wiki/California_Institute_of_Technology "California Institute of Technology")
3.  ^ [_**a**_](#cite_ref-HornJohnson_3-0) [_**b**_](#cite_ref-HornJohnson_3-1) Horn, Roger A.; Johnson, Charles R. (2013). _Matrix Analysis, second edition_. Cambridge University Press. [ISBN](http://fakehost/wiki/International_Standard_Book_Number "International Standard Book Number") [9780521839402](http://fakehost/wiki/Special:BookSources/9780521839402 "Special:BookSources/9780521839402").
4.  **[^](#cite_ref-4)** Also known as the **Rayleigh–Ritz ratio**; named after [Walther Ritz](http://fakehost/wiki/Walther_Ritz "Walther Ritz") and [Lord Rayleigh](http://fakehost/wiki/Lord_Rayleigh "Lord Rayleigh").
5.  **[^](#cite_ref-5)** Parlet B. N. _The symmetric eigenvalue problem_, SIAM, Classics in Applied Mathematics,1998

External links\[[edit](http://fakehost/w/index.php?title=Hermitian_matrix&action=edit&section=12 "Edit section: External links")\]
-------------------------------------------------------------------------------------------------------------------

*   [Hazewinkel, Michiel](http://fakehost/wiki/Michiel_Hazewinkel "Michiel Hazewinkel"), ed. (2001) \[1994\], ["Hermitian matrix"](https://www.encyclopediaofmath.org/index.php?title=p/h047070), _[Encyclopedia of Mathematics](http://fakehost/wiki/Encyclopedia_of_Mathematics "Encyclopedia of Mathematics")_, Springer Science+Business Media B.V. / Kluwer Academic Publishers, [ISBN](http://fakehost/wiki/International_Standard_Book_Number "International Standard Book Number") [978-1-55608-010-4](http://fakehost/wiki/Special:BookSources/978-1-55608-010-4 "Special:BookSources/978-1-55608-010-4")
