...
[A trademark battle in the Arduino community](http://fakehost/Articles/637755%29
----------------------------------------------------------------
...
The Arduino project grew out of 2005-era course work taught at the Interaction Design Institute Ivrea (IDII) in Ivrea, Italy (using [Processing](https://en.wikipedia.org/wiki/Processing_\%28programming_language\%29), [Wiring](https://en.wikipedia.org/wiki/Wiring_%28development_platform%29), and pre-existing microcontroller hardware). After the IDII program was discontinued, the open-hardware Arduino project as we know it was launched by Massimo Banzi, David Cuartielles, and David Mellis (who had worked together at IDII), with co-founders Tom Igoe and Gianluca Martino joining shortly afterward. The project released open hardware designs (including full schematics and design files) as well as the microcontroller software to run on the boards and the desktop IDE needed to program it.
...
This division of responsibilities—with the main Arduino project handling everything except for board manufacturing—may seem like an odd one, but it is consistent with Arduino's marketing story. From its earliest days, the designs for the hardware have been freely available, and outside companies were allowed to make Arduino-compatible devices. The project has long run a [certification program](http://arduino.cc/en/ArduinoCertified/Products#program) for third-party manufacturers interested in using the "Arduino" branding, but allows (and arguably even encourages) informal software and firmware compatibility.

The Arduino branding was not formally registered as a trademark in the early days, however. Arduino LLC [filed](http://tsdr.uspto.gov/#caseNumber=3931675&caseType=US_REGISTRATION_NO&searchType=statusSearch) to register the US trademark in April 2009, and it was granted in 2011.

At this point, the exact events begin to be harder to verify, but the original group of founders reportedly had a difference of opinion about how to license out hardware production rights to other companies. Wired Italy [reports](http://www.wired.it/gadget/computer/2015/02/12/arduino-nel-caos-situazione%29 that Martino and Smart Projects resisted the other four founders' plans to "internationalize" production—although it is not clear if that meant that Smart Projects disapproved of licensing out _any_ official hardware manufacturing to other companies, or had some other concern. Heise Online [adds](http://www.heise.de/make/meldung/Arduino-gegen-Arduino-Gruender-streiten-um-die-Firma-2549653.html) that the conflict seemed to be about moving some production to China.

What is clear is that Smart Projects filed a [petition](http://ttabvue.uspto.gov/ttabvue/v?pno=92060077&pty=CAN&eno=1) with the US Patent and Trademark Office (USPTO) in October 2014 asking the USPTO to cancel Arduino LLC's trademark on "Arduino." Then, in November 2014, Smart Projects changed its company's name to Arduino SRL. Somewhere around that time, Martino sold off his ownership stake in Smart Projects SRL and new owner Federico Musto was named CEO.

Unsurprisingly, Arduino LLC did not care for the petition to the USPTO and, in January 2015, the company filed a trademark-infringement [lawsuit](http://dockets.justia.com/docket/massachusetts/madce/1:2015cv10181/167131) against Arduino SRL. Confusing matters further, the re-branded Arduino SRL has set up its own web site using the domain name arduino.org, which duplicates most of the site features found on the original Arduino site (arduino.cc). That includes both a hardware store and software downloads.

Musto, the new CEO of the company now called Arduino SRL, has a bit of a history with Arduino as well. His other manufacturing business had [collaborated](http://www.eetimes.com/document.asp?doc_id=1263246) with Arduino LLC on the design and production of the Arduino Yún, which has received some [criticism](http://hackaday.com/2015/02/24/is-the-arduino-yun-open-hardware%29 for including proprietary components.

Hackaday has run a two-part series (in [February](http://hackaday.com/2015/02/25/arduino-v-arduino/) and [March](http://hackaday.com/2015/03/12/arduino-v-arduino-part-ii%29) digging into the ins and outs of the dispute, including the suggestion that Arduino LLC's recent release of version 1.6.0 of the Arduino IDE was a move intended to block Arduino SRL from hijacking IDE development. Commenter Paul Stoffregen (who was the author of the Heise story above) [noted](http://hackaday.com/2015/02/25/arduino-v-arduino/comment-page-1/#comment-2453084) that Arduino SRL recently created a fork of the Arduino IDE on GitHub.

Most recently, Banzi broke his silence about the dispute in a [story](http://makezine.com/2015/03/19/massimo-banzi-fighting-for-arduino) published at MAKEzine. There, Banzi claims that Martino secretly filed a trademark application on "Arduino" in Italy in 2008 and told none of the other Arduino founders. He also details a series of unpleasant negotiations between the companies, including Smart Projects stopping the royalty payments it had long sent to Arduino LLC for manufacturing devices and re-branding its boards with the Arduino.org URL.

Users appear to be stuck in the middle. Banzi says that several retail outlets that claim to be selling "official" Arduino boards are actually paying Arduino SRL, not Arduino LLC, but it is quite difficult to determine which retailers are lined up on which side, since there are (typically) several levels of supplier involved. The two Arduino companies' web sites also disagree about the available hardware, with Arduino.org offering the new [Arduino Zero](http://arduino.org/products/arduino-zero-pro) model for sale today and Arduino.cc [listing it](http://arduino.cc/en/Main/Products) as "Coming soon."
...
[Comments (5 posted)](http://fakehost/Articles/637755/#Comments)

[Mapping and data mining with QGIS 2.8](http://fakehost/Articles/637533%29
----------------------------------------------------------
...
All three have been improved in this release. New are support for if(condition, true, false) conditional statements, a set of operations for geometry primitives (e.g., to test whether regions overlap or lines intersect), and an "integer divide" operation. Users can also add comments to their queries to annotate their code, and there is a new [custom function editor](http://nathanw.net/2015/01/19/function-editor-for-qgis-expressions%29 for writing Python functions that can be called in mathematical expressions within the query builder.
...
[Comments (3 posted)](http://fakehost/Articles/637533/#Comments)

[Development activity in LibreOffice and OpenOffice](http://fakehost/Articles/637735%29
-----------------------------------------------------------------------

By **Jonathan Corbet**  
March 25, 2015

The LibreOffice project was [announced](http://fakehost/Articles/407383/) with great fanfare in September 2010. Nearly one year later, the OpenOffice.org project (from which LibreOffice was forked) [was cut loose from Oracle](http://fakehost/Articles/446093%29 and found a new home as an Apache project. It is fair to say that the rivalry between the two projects in the time since then has been strong. Predictions that one project or the other would fail have not been borne out, but that does not mean that the two projects are equally successful. A look at the two projects' development communities reveals some interesting differences.

#### Release histories

Apache OpenOffice has made two releases in the past year: [4.1](https://blogs.apache.org/OOo/entry/the_apache_openoffice_project_announce) in April 2014 and [4.1.1](https://blogs.apache.org/OOo/entry/announcing_apache_openoffice_4_1) (described as "a micro update" in the release announcement) in August. The main feature added during that time would appear to be significantly improved accessibility support.
...
* Most active OpenOffice developers:                                                                                                                                                                                                                                                                         By changesets
* Most active OpenOffice developers: Herbert Dürr
  * 63
  * 16.6%
* Most active OpenOffice developers: Jürgen Schmidt             
  * 56
  * 14.7%
* Most active OpenOffice developers: Armin Le Grand
  * 56
  * 14.7%
* Most active OpenOffice developers: Oliver-Rainer Wittmann
  * 46
  * 12.1%
* Most active OpenOffice developers: Tsutomu Uchino
  * 33
  * 8.7%
* Most active OpenOffice developers: Kay Schenk
  * 27
  * 7.1%
* Most active OpenOffice developers: Pedro Giffuni
  * 23
  * 6.1%
* Most active OpenOffice developers: Ariel Constenla-Haile
  * 22
  * 5.8%
* Most active OpenOffice developers: Andrea Pescetti
  * 14
  * 3.7%
* Most active OpenOffice developers: Steve Yin
  * 11
  * 2.9%
* Most active OpenOffice developers: Andre Fischer
  * 10
  * 2.6%
* Most active OpenOffice developers: Yuri Dario
  * 7
  * 1.8%
* Most active OpenOffice developers: Regina Henschel
  * 6
  * 1.6%
* Most active OpenOffice developers: Juan C. Sanz
  * 2
  * 0.5%
* Most active OpenOffice developers: Clarence Guo
  * 2
  * 0.5%
* Most active OpenOffice developers: Tal Daniel
  * 2
  * 0.5%
...
* Most active LibreOffice developers:                                                                                                                                                                                                                                                                         By changesets
* Most active LibreOffice developers: Caolán McNamara
  * 4307
  * 19.5%
* Most active LibreOffice developers: Stephan Bergmann
  * 2351
  * 10.6%
* Most active LibreOffice developers: Miklos Vajna
  * 1449
  * 6.5%
* Most active LibreOffice developers: Tor Lillqvist
  * 1159
  * 5.2%
* Most active LibreOffice developers: Noel Grandin
  * 1064
  * 4.8%
* Most active LibreOffice developers: Markus Mohrhard
  * 935
  * 4.2%
* Most active LibreOffice developers: Michael Stahl
  * 915
  * 4.1%
* Most active LibreOffice developers: Kohei Yoshida
  * 755
  * 3.4%
* Most active LibreOffice developers: Tomaž Vajngerl
  * 658
  * 3.0%
* Most active LibreOffice developers: Thomas Arnhold
  * 619
  * 2.8%
* Most active LibreOffice developers: Jan Holesovsky
  * 466
  * 2.1%
* Most active LibreOffice developers: Eike Rathke
  * 457
  * 2.1%
* Most active LibreOffice developers: Matteo Casalin
  * 442
  * 2.0%
* Most active LibreOffice developers: Bjoern Michaelsen
  * 421
  * 1.9%
* Most active LibreOffice developers: Chris Sherlock
  * 396
  * 1.8%
* Most active LibreOffice developers: David Tardon
  * 386
  * 1.7%
* Most active LibreOffice developers: Julien Nabet
  * 362
  * 1.6%
* Most active LibreOffice developers: Zolnai Tamás
  * 338
  * 1.5%
* Most active LibreOffice developers: Matúš Kukan
  * 256
  * 1.2%
* Most active LibreOffice developers: Robert Antoni Buj Gelonch
  * 231
  * 1.0%
