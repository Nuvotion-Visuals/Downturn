...
So we sat in our student newsroom—not very happy with what we were doing. Our weekly newspaper had remained essentially unchanged for 40+ years. Each editorial position had the same requirement every year. The _big_ change happened in the 80s when the paper started using colour. We’d also stumbled into having a website, but it was updated just once a week with the release of the newspaper.
...
When a newsroom decides to create a position for the web, it’s often with the intent of having content flow steadily from writers onto the web. This is a big improvement from just uploading stories to the web whenever there is a print issue. _However…_
...
_This isn’t supposed to be a_ **_manifesto™©_** _we just think it’s pretty cool to share what we’ve learned so far, and hope you’ll do the same. We’re all in this together._